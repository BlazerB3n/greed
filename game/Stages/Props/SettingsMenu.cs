...
namespace Greed.Game.Screens.Menus
{
    public class SettingsMenu : IMenu
    {
        ...
        Button prev = null;
        ButtonUpDown framesUPdown = null;

         public SettingsMenu(int x, int y, int width, int height, InputService input)
        {
            this.x = x;
            this.y = y;
            inputService = input;
            ...
            framesUPdown = new ButtonUpDown(x + (width/16), y + ((height/4) + height/8), "Frame speed", 34 );
        ...
        public void DoUpdates()
        {
            ...
            switch(framesUPdown.isButtonPressed(mousePoint))
            {
                case -1:
                    
                    SYSTEM_SETTINGS.FRAME_RATE = SYSTEM_SETTINGS.FRAME_RATE - 1;
            ...
            Title.SetMessage("Settings FPS:" + Raylib.GetFPS());
        ...
        private void DoButtonSetup()
        {
            ...
            MenuCast.AddActorList("frames", framesUPdown.GetCast());
